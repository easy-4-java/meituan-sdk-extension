...
public interface MeituanStoreService extends MeituanService {
    ...
    /**
     * 游标查询交易结算流水(服务商使用)。
     * <p>官方接口：{@code /solution2/csaccount/scrollQueryTradeProfitDetailOpPoiId}，API：{@code dc_srcoll_query_trade_profit_detail_for_oppoiid}，版本：{@code 10007}，businessId：{@code 86}，需要授权：{@code 是}。</p>
     *
     * @param request  官方 MtOpJavaSDK 请求对象
     * @param tenantId 租户标识，用于选择对应的 appAuthToken
     * @return 官方 SDK 反序列化后的响应
    ...
    /**
     * 批量查询微信支付订单商企通信息。
     * <p>官方接口：{@code /solution2/mtcompany/wechat/sqtInfo/batch/query}，API：{@code wechat_order_sqt_info_batch_query}，版本：{@code 10002}，businessId：{@code 86}，需要授权：{@code 是}。</p>
     *
     * @param request  官方 MtOpJavaSDK 请求对象
     * @param tenantId 租户标识，用于选择对应的 appAuthToken
     * @return 官方 SDK 反序列化后的响应
